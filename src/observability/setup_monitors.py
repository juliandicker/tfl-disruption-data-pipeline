...
MONITORS = [
    ...
    },
    {
        ...
        "streaming_table": False,  # materialized view — CDF not applicable
    },
]
...
for m in MONITORS:
    table = m["table_name"]
    if m.get("streaming_table"):
        spark.sql(f"ALTER STREAMING TABLE {table} SET TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')")
